          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            {favoriteRecipes.length > 0 && (
              <Button
                ...
                variant="outline"
                className="border-destructive text-destructive hover:bg-destructive hover:text-destructive-foreground transition-all duration-300 whitespace-nowrap"
              >
                ...
                <CardContent className="p-4">
                  <p className="text-muted-foreground">
                    {filteredRecipes.length > 0 ? (
                      <>Showing {filteredRecipes.length} of {favoriteRecipes.length} favorite recipes matching "{searchQuery}"</>
                    ) : (
                      <>No favorite recipes found matching "{searchQuery}"</>
                    )}
                  </p>
                </CardContent>
              </Card>
                  ...
                  <Card key={category} className="border-0 shadow-soft">
                    ...
                    <CardContent>
                      <RecipeGrid
                        ...
                        emptyMessage={`No ${category} recipes in your favorites`}
                      />
                    </CardContent>
                  </Card>
                ))}
